  ...
  return (
    <>
      ...
      <motion.section 
        ...
        className="relative bg-[#0685B1] z-99 top-[100px] text-white py-2 text-xl font-normal overflow-hidden whitespace-nowrap flex items-center w-full select-none"
      >
