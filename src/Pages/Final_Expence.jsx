...
const FinalExpence = () => {
  ...
  <img 
    src="https://res.cloudinary.com/diicgo6ay/image/upload/v1777662108/Final-Expense-Marketing-Idea-INS-FEI-1002-2861839687_1_arokbs.jpg" 
  ...
  <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
    <h1 className="text-3xl pt-32 md:pt-7 md:text-7xl font-bold text-white">FinalExpence</h1>
    <h1 className="sm:mt-4  text-xl sm:text-3xl text-white">
       Get FinalExpence Quotes from Trusted Providers
    </h1>
  </div>
</header>
